    ...
    protected void btnconfirm_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (cbFB.Checked == true)//发布
                ...
                isfb = "0";//不发布
            string str = "insert into tb_test(testContent,testAns1,testAns2,testAns3,testAns4,rightAns,pub,testCourse,class) values('" + txtsubject.Text.Trim() + "',' ',' ',' ',' ','" + rblRightAns.SelectedValue.ToString() + "','" + isfb + "','" + ddlkm.SelectedItem.Text + "','判断题')";
